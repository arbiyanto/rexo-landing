...
export function AppScreen({ children, className, ...props }) {
  return (
    <div className={clsx('flex flex-col', className)} {...props}>
      <div className="flex justify-between px-4 pt-4 bg-gradient-to-r from-teal-600 to-teal-500 rounded-t-xl">
...
AppScreen.Header = forwardRef(function AppScreenHeader({ children }, ref) {
  return (
    <div ref={ref} className="mt-4 px-4 text-white pt-2 pb-4 bg-gradient-to-r from-teal-600 to-teal-500">
      {children}
    </div>
  )
})
...
AppScreen.Subtitle = forwardRef(function AppScreenSubtitle({ children }, ref) {
  return (
    <div ref={ref} className="text-sm text-teal-100 mt-1">
      {children}
    </div>
  )
})
...
AppScreen.Body = forwardRef(function AppScreenBody(
  ...
  return (
    <div
      ref={ref}
      className={clsx('flex-auto rounded-b-2xl bg-white shadow-inner', className)}
    >
      {children}
    </div>
  )
