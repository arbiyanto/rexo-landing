...
export const metadata = {
  title: 'Kebijakan Privasi | Rexo',
  description: 'Kebijakan privasi Rexo tentang penggunaan data dan informasi pengguna.',
}
...
export default function PrivacyPolicy() {
  ...
  const markdownContent = fs.readFileSync(
    path.join(process.cwd(), 'src/markdown/privacy-policy.md'),
    'utf8'
  )
